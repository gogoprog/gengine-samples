...
Application.start = function(engine) {
	...
	engine.addEntity(e);
	var tmp6 = gengine.getRenderer().getDefaultZone();
	var this7 = Module.Color(0.5,0.5,0.5,1);
	tmp6.setFogColor(this7);
	var tmp7 = engine.getSystem(FactorySystem);
	var this8 = Module.Vector3(0,300,0);
	tmp7.spawnCrate(64,this8);
	var result = new Module.PhysicsRaycastResult2D();
	var tmp8 = sceneEntity.get(gengine_components_PhysicsWorld2D);
	var this9 = Module.Vector2(0,0);
	var this10 = Module.Vector2(0,-2000);
	tmp8.raycastSingle(result,this9,this10,4294967295);
};
