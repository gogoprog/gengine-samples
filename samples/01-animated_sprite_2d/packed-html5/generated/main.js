...
Application.start = function(engine) {
	...
	e.add(new gengine_components_AnimatedSprite2D());
	var animatedSprite2D = e.get(gengine_components_AnimatedSprite2D);
	var animationSet = gengine.getResourceCache().getAnimationSet2D("spriter/player.scml",true);
	animatedSprite2D.object.setAnimationSet(animationSet);
	animatedSprite2D.object.setAnimation("walk",1);
	var this1 = Module.Vector3(-200,-200,0);
	e.set_position(this1);
	engine.addEntity(e);
	var e1 = new gengine_Entity();
	e1.add(new gengine_components_AnimatedSprite2D());
	var animatedSprite2D1 = e1.get(gengine_components_AnimatedSprite2D);
	var animationSet1 = gengine.getResourceCache().getAnimationSet2D("spine/spineboy.json",true);
	animatedSprite2D1.object.setAnimationSet(animationSet1);
	animatedSprite2D1.object.setAnimation("walk",1);
	var this2 = Module.Vector3(200,-200,0);
	e1.set_position(this2);
	var this3 = Module.Vector3(0.5,0.5,1);
	var scale = this3;
	e1.node.setScale(scale);
	engine.addEntity(e1);
	var tmp = gengine.getRenderer().getDefaultZone();
	var this4 = Module.Color(1,1,1,1);
	tmp.setFogColor(this4);
};
...
var gengine_components_AnimatedSprite2D = function() {
	if(this.object == null) {
		this.object = new Module.AnimatedSprite2D(gengine.getContext());
		if('AnimatedSprite2D' == 'ParticleEmitter2D') { window.dummyNode.addComponent(this.object, 0, 0); }
	}
	gengine_components_StaticSprite2D.call(this);
};
gengine_components_AnimatedSprite2D.__name__ = ["gengine","components","AnimatedSprite2D"];
gengine_components_AnimatedSprite2D.__super__ = gengine_components_StaticSprite2D;
gengine_components_AnimatedSprite2D.prototype = $extend(gengine_components_StaticSprite2D.prototype,{
	getTypeName3: function() {
		return this.object.getTypeName3();
	}
	,onSetEnabled2: function() {
		this.object.onSetEnabled2();
	}
	,setAnimationSet: function(animationSet) {
		this.object.setAnimationSet(animationSet);
	}
	,setEntity: function(name) {
		this.object.setEntity(name);
	}
	,setAnimation: function(name,loopMode) {
	...
	,getAnimationSet: function() {
		return this.object.getAnimationSet();
	}
	,getEntity: function() {
	...
	,getLoopMode: function() {
		return this.object.getLoopMode();
	}
	,getSpeed: function() {
		return this.object.getSpeed();
	}
	,setAnimationAttr: function(name) {
		this.object.setAnimationAttr(name);
	}
	,getBonePosition: function(boneIndex) {
		return this.object.getBonePosition(boneIndex);
	}
	,__class__: gengine_components_AnimatedSprite2D
});
