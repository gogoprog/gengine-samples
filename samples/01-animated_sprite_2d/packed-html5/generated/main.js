...
Application.start = function(engine) {
	...
	animatedSprite2D1.setAnimationSet(animationSet1);
	animatedSprite2D1.setAnimation("walk");
...
var gengine_components_AnimatedSprite2D = function(animationSet,animation,loopMode) {
	if(loopMode == null) {
		loopMode = 0;
	}
	...
	if(animationSet != null) {
		...
		if(animation != null) {
			this.setAnimation(animation,loopMode);
		}
	}
};
gengine_components_AnimatedSprite2D.__name__ = ["gengine","components","AnimatedSprite2D"];
gengine_components_AnimatedSprite2D.__super__ = gengine_components_UrhoComponent;
gengine_components_AnimatedSprite2D.prototype = $extend(gengine_components_UrhoComponent.prototype,{
