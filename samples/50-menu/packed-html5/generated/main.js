...
GameSystem.prototype = $extend(ash_core_System.prototype,{
	addToEngine: function(engine) {
		this.modelEntity = new gengine_Entity();
		this.modelEntity.add(new gengine_components_AnimatedModel());
		var tmp = this.modelEntity.get(gengine_components_AnimatedModel);
		var tmp1 = gengine.getResourceCache().getModel("Ninja.mdl",true);
		tmp.setModel1(tmp1,true);
		var tmp2 = this.modelEntity.get(gengine_components_AnimatedModel);
		var tmp3 = gengine.getResourceCache().getMaterial("Ninja.xml",true);
		tmp2.setMaterial1(tmp3);
		var tmp4 = this.modelEntity;
		var this1 = Module.Vector3(-0.7,0,-0.2);
		tmp4.setPosition(this1);
		engine.addEntity(this.modelEntity);
		var animation = gengine.getResourceCache().getAnimation("Ninja_Idle1.ani",true);
		var state = this.modelEntity.get(gengine_components_AnimatedModel).addAnimationState(animation);
		state.setWeight(1.0);
		state.setLooped(true);
		state.setTime(0);
	}
	,update: function(dt) {
		this.modelEntity.node.yaw(dt * 20,0);
		var state = this.modelEntity.get(gengine_components_AnimatedModel).getAnimationState(0);
		state.addTime(dt);
...
Application.start = function(engine) {
	...
	var this1 = Module.Vector3(0.0,2.0,-3.0);
	cameraEntity.setPosition(this1);
	...
	cameraEntity.node.lookAt(this2,upVector,2);
	...
	lightEntity.add(new gengine_components_Light());
	engine.addEntity(lightEntity);
	var this4 = Module.Vector3(0.0,5.0,-5.0);
	lightEntity.setPosition(this4);
	var this5 = Module.Vector3(0.0,-1.0,1.0);
	lightEntity.node.setDirection(this5);
	lightEntity.get(gengine_components_Light).setLightType(1);
};
