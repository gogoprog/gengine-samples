...
Application.start = function(engine) {
	...
	var effect = gengine.getResourceCache().getParticleEffect2D("sun.pex",true);
	particleEmitter2D.object.setEffect(effect);
	engine.addEntity(e);
	e = new gengine_Entity();
	e.add(new gengine_components_ParticleEmitter2D());
	particleEmitter2D = e.get(gengine_components_ParticleEmitter2D);
	var effect1 = gengine.getResourceCache().getParticleEffect2D("greenspiral.pex",true);
	particleEmitter2D.object.setEffect(effect1);
	engine.addEntity(e);
...
var gengine_components_ParticleEmitter2D = function() {
	if(this.object == null) {
		...
		if('ParticleEmitter2D' == 'ParticleEmitter2D') { window.dummyNode.addComponent(this.object, 0, 0); }
	}
...
gengine_components_ParticleEmitter2D.__super__ = gengine_components_Drawable2D;
gengine_components_ParticleEmitter2D.prototype = $extend(gengine_components_Drawable2D.prototype,{
	...
	,setMaxParticles: function(maxParticles) {
		this.object.setMaxParticles(maxParticles);
	}
	,getEffect: function() {
	...
	,getMaxParticles: function() {
		return this.object.getMaxParticles();
	}
