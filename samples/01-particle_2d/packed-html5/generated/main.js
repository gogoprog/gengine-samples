...
Application.init = function() {
	gengine.setWindowSize(Module.IntVector2(640,480));
...
Application.start = function(engine) {
	...
	e.add(new gengine_components_ParticleEmitter2D());
	var particleEmitter2D = e.get(gengine_components_ParticleEmitter2D);
	particleEmitter2D.setEffect(gengine.getResourceCache().getParticleEffect2D("sun.pex",true));
	engine.addEntity(e);
	e = new gengine_Entity();
	e.add(new gengine_components_ParticleEmitter2D());
	particleEmitter2D = e.get(gengine_components_ParticleEmitter2D);
	particleEmitter2D.setEffect(gengine.getResourceCache().getParticleEffect2D("greenspiral.pex",true));
	engine.addEntity(e);
	gengine.getRenderer().getDefaultZone().setFogColor(Module.Color(0,0,0,1));
};
...
var gengine_components_ParticleEmitter2D = function() {
	gengine_components_UrhoComponent.call(this);
	this.object = new Module.ParticleEmitter2D(gengine.getContext());
	window.dummyNode.addComponent(this.object, 0, 0);;
};
gengine_components_ParticleEmitter2D.__name__ = ["gengine","components","ParticleEmitter2D"];
gengine_components_ParticleEmitter2D.__super__ = gengine_components_UrhoComponent;
gengine_components_ParticleEmitter2D.prototype = $extend(gengine_components_UrhoComponent.prototype,{
	...
	,__class__: gengine_components_ParticleEmitter2D
});
